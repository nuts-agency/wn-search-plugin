...
namespace Nuts\Search\Behaviors;

use Nuts\Search\Classes\ModelObserver;
use Nuts\Search\Classes\SearchableScope;
use Nuts\Search\Classes\EngineManager;
use Winter\Storm\Extension\ExtensionBase;
use Winter\Storm\Support\Arr;
use Winter\Storm\Database\Traits\SoftDelete;
use Illuminate\Support\Collection as BaseCollection;
use Nuts\Search\Classes\Builder;
...
class Searchable extends ExtensionBase
{
    ...
    public static function search($query = '', $callback = null)
    {
        ...
        return app(Builder::class, [
            ...
            'query' => $query,
            'callback' => $callback,
            'softDelete'=> static::usesSoftDelete() && config('search.soft_delete', false),
        ]);
    }
    ...
    {
        return config('search.prefix') . $this->model->getTable();
    }
    ...
    {
        return config('search.queue.connection') ?: config('queue.default');
    }
    ...
    {
        return config('search.queue.queue');
    }
